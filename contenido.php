...
if (isset($_SESSION['usuario']))
{
	...
	<body  class="cuerpo">
		...
		<div> 
			...
			<p style="color: black;padding-left: 100px; padding-right: 100px">Adicione una tabla de notas por materia y cuente la cantidad de aprobados por departamento de manera que solo obtenga una sola fila de resultados con SQL (Dos posibles formas, una mediante el conteo y otra mediante función de la BD o SGBD).</p>
			<?php 
			...
			echo '<table align="left" color:"black">';
	...
	and n.nota > 50";
			...
			echo '<table align="left" margin:"30px 30px 30px 30px">';
